...
public class InventoryDTO {
    ...
    public InventoryDTO(BigInteger id, String name, BigInteger stock, BigDecimal unit_price, BigDecimal sale_price, BigInteger id_product, BigInteger id_supplier) {
        this.id = id;
        this.name = name;
        this.stock = stock;
